...
function Library:New3DLine()
	...
	spawn(function()RS:BindToRenderStep(step_Id, 1, _line.Update)end)
	-- Remove Line --
...
function Library:New3DCube()
	...
	spawn(function()RS:BindToRenderStep(step_Id, 1, _cube.Update)end)
...
function Library:New3DSquare()
	...
	spawn(function()RS:BindToRenderStep(step_Id, 1, _square.Update)end)
...
function Library:New3DCircle()
	...
	spawn(function()RS:BindToRenderStep(step_Id, 1, _circle.Update) end)
